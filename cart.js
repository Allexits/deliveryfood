       ...
       // console.log(flag_form);
        if(flag_form){
                ...
                for(var str_id in cart){
                    ...
                    c++;
                    out_goods+='<p><b>'+c+'</b> '+oneGood.name+' '+oneGood.cost+' грн. * '+cart[str_id]+' = '+oneGood.cost*cart[str_id]+' грн.</p>'; 
                    }
                ...
                out_string+= '<hr>';
                out_string+= '<div class="row"><div class="col-4"><b>Total price:</b></div><div class="col-4"> <b>'+total_price+' грн.</b></div></div>';            
